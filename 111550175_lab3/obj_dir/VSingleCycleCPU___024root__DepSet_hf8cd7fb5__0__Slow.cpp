...
VL_ATTR_COLD void VSingleCycleCPU___024root___dump_triggers__act(VSingleCycleCPU___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(2U)) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @([changed] SingleCycleCPU.__Vcellinp__m_Control__opcode or [changed] SingleCycleCPU.if_o_2)\n");
    }
    if (vlSelf->__VactTriggered.at(3U)) {
        VL_DBG_MSGF("         'act' region trigger index 3 is active: @([changed] SingleCycleCPU.ex_o_1 or [changed] SingleCycleCPU.sum_1 or [changed] SingleCycleCPU.w1)\n");
    }
    if (vlSelf->__VactTriggered.at(4U)) {
        VL_DBG_MSGF("         'act' region trigger index 4 is active: @([changed] SingleCycleCPU.ex_o_9 or [changed] SingleCycleCPU.mux_pc_output or [changed] SingleCycleCPU.sum_jalr)\n");
    }
    if (vlSelf->__VactTriggered.at(5U)) {
        VL_DBG_MSGF("         'act' region trigger index 5 is active: @([changed] SingleCycleCPU.id_o_15 or [changed] SingleCycleCPU.id_o_3 or [changed] SingleCycleCPU.id_o_4)\n");
    }
    if (vlSelf->__VactTriggered.at(6U)) {
        VL_DBG_MSGF("         'act' region trigger index 6 is active: @([changed] SingleCycleCPU.ex_o_11 or [changed] SingleCycleCPU.ex_o_3)\n");
    }
    if (vlSelf->__VactTriggered.at(7U)) {
        VL_DBG_MSGF("         'act' region trigger index 7 is active: @([changed] SingleCycleCPU.mem_o_1 or [changed] SingleCycleCPU.mem_o_2 or [changed] SingleCycleCPU.mem_o_5)\n");
    }
    if (vlSelf->__VactTriggered.at(8U)) {
        VL_DBG_MSGF("         'act' region trigger index 8 is active: @([changed] SingleCycleCPU.mem_o_6 or [changed] SingleCycleCPU.mux_writedata_output or [changed] SingleCycleCPU.sum_1)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VSingleCycleCPU___024root___dump_triggers__nba(VSingleCycleCPU___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(2U)) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @([changed] SingleCycleCPU.__Vcellinp__m_Control__opcode or [changed] SingleCycleCPU.if_o_2)\n");
    }
    if (vlSelf->__VnbaTriggered.at(3U)) {
        VL_DBG_MSGF("         'nba' region trigger index 3 is active: @([changed] SingleCycleCPU.ex_o_1 or [changed] SingleCycleCPU.sum_1 or [changed] SingleCycleCPU.w1)\n");
    }
    if (vlSelf->__VnbaTriggered.at(4U)) {
        VL_DBG_MSGF("         'nba' region trigger index 4 is active: @([changed] SingleCycleCPU.ex_o_9 or [changed] SingleCycleCPU.mux_pc_output or [changed] SingleCycleCPU.sum_jalr)\n");
    }
    if (vlSelf->__VnbaTriggered.at(5U)) {
        VL_DBG_MSGF("         'nba' region trigger index 5 is active: @([changed] SingleCycleCPU.id_o_15 or [changed] SingleCycleCPU.id_o_3 or [changed] SingleCycleCPU.id_o_4)\n");
    }
    if (vlSelf->__VnbaTriggered.at(6U)) {
        VL_DBG_MSGF("         'nba' region trigger index 6 is active: @([changed] SingleCycleCPU.ex_o_11 or [changed] SingleCycleCPU.ex_o_3)\n");
    }
    if (vlSelf->__VnbaTriggered.at(7U)) {
        VL_DBG_MSGF("         'nba' region trigger index 7 is active: @([changed] SingleCycleCPU.mem_o_1 or [changed] SingleCycleCPU.mem_o_2 or [changed] SingleCycleCPU.mem_o_5)\n");
    }
    if (vlSelf->__VnbaTriggered.at(8U)) {
        VL_DBG_MSGF("         'nba' region trigger index 8 is active: @([changed] SingleCycleCPU.mem_o_6 or [changed] SingleCycleCPU.mux_writedata_output or [changed] SingleCycleCPU.sum_1)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VSingleCycleCPU___024root___ctor_var_reset(VSingleCycleCPU___024root* vlSelf) {
    ...
    vlSelf->SingleCycleCPU__DOT__if_o_1 = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__if_o_2 = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__id_o_1 = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__id_o_2 = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__id_o_3 = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__id_o_4 = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__id_o_6 = VL_RAND_RESET_I(3);
    vlSelf->SingleCycleCPU__DOT__id_o_16 = VL_RAND_RESET_I(3);
    vlSelf->SingleCycleCPU__DOT__id_o_7 = VL_RAND_RESET_I(5);
    vlSelf->SingleCycleCPU__DOT__id_o_5 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__id_o_8 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__id_o_9 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__id_o_10 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__id_o_11 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__id_o_12 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__id_o_13 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__id_o_14 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__id_o_15 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__ex_o_1 = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__ex_o_3 = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__ex_o_4 = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__ex_o_5 = VL_RAND_RESET_I(5);
    vlSelf->SingleCycleCPU__DOT__ex_o_2 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__ex_o_6 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__ex_o_7 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__ex_o_8 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__ex_o_9 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__ex_o_10 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__ex_o_11 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__ex_o_12 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__mem_o_1 = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__mem_o_2 = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__mem_o_3 = VL_RAND_RESET_I(5);
    vlSelf->SingleCycleCPU__DOT__mem_o_4 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__mem_o_5 = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__mem_o_6 = VL_RAND_RESET_I(1);
    ...
    vlSelf->__Vdly__SingleCycleCPU__DOT__ex_o_1 = VL_RAND_RESET_I(32);
    ...
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__if_o_2 = VL_RAND_RESET_I(32);
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__ex_o_1 = VL_RAND_RESET_I(32);
    ...
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__ex_o_9 = VL_RAND_RESET_I(1);
    ...
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__id_o_15 = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__id_o_3 = VL_RAND_RESET_I(32);
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__id_o_4 = VL_RAND_RESET_I(32);
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__ex_o_11 = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__ex_o_3 = VL_RAND_RESET_I(32);
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__mem_o_1 = VL_RAND_RESET_I(32);
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__mem_o_2 = VL_RAND_RESET_I(32);
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__mem_o_5 = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__mem_o_6 = VL_RAND_RESET_I(1);
