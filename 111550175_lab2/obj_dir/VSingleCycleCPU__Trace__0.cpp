...
void VSingleCycleCPU___024root__trace_chg_sub_0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        ...
        bufp->chgIData(oldp+38,(vlSelf->SingleCycleCPU__DOT__sum_1),32);
        bufp->chgCData(oldp+39,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Control__opcode),7);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[4U])) {
        bufp->chgCData(oldp+40,(vlSelf->SingleCycleCPU__DOT__ALU_ctl),4);
        bufp->chgCData(oldp+41,(vlSelf->SingleCycleCPU__DOT__ALU_Op),3);
        bufp->chgBit(oldp+42,(vlSelf->SingleCycleCPU__DOT__mem_read));
        bufp->chgBit(oldp+43,(vlSelf->SingleCycleCPU__DOT__mem_to_reg));
        bufp->chgBit(oldp+44,(vlSelf->SingleCycleCPU__DOT__mem_write));
        bufp->chgBit(oldp+45,(vlSelf->SingleCycleCPU__DOT__ALU_src));
        bufp->chgBit(oldp+46,(vlSelf->SingleCycleCPU__DOT__reg_write));
        bufp->chgBit(oldp+47,(vlSelf->SingleCycleCPU__DOT__jal_con));
        bufp->chgBit(oldp+48,(vlSelf->SingleCycleCPU__DOT__jalr_con));
        bufp->chgBit(oldp+49,(vlSelf->SingleCycleCPU__DOT__branc));
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[5U])) {
        bufp->chgIData(oldp+50,(vlSelf->SingleCycleCPU__DOT__ALU_res),32);
        bufp->chgBit(oldp+51,(vlSelf->SingleCycleCPU__DOT__zero_o));
        bufp->chgBit(oldp+52,(vlSelf->SingleCycleCPU__DOT__w1));
    }
    bufp->chgBit(oldp+53,(vlSelf->clk));
    bufp->chgBit(oldp+54,(vlSelf->start));
    bufp->chgIData(oldp+55,(vlSelf->r[0]),32);
    bufp->chgIData(oldp+56,(vlSelf->r[1]),32);
    bufp->chgIData(oldp+57,(vlSelf->r[2]),32);
    bufp->chgIData(oldp+58,(vlSelf->r[3]),32);
    bufp->chgIData(oldp+59,(vlSelf->r[4]),32);
    bufp->chgIData(oldp+60,(vlSelf->r[5]),32);
    bufp->chgIData(oldp+61,(vlSelf->r[6]),32);
    bufp->chgIData(oldp+62,(vlSelf->r[7]),32);
    bufp->chgIData(oldp+63,(vlSelf->r[8]),32);
    bufp->chgIData(oldp+64,(vlSelf->r[9]),32);
    bufp->chgIData(oldp+65,(vlSelf->r[10]),32);
    bufp->chgIData(oldp+66,(vlSelf->r[11]),32);
    bufp->chgIData(oldp+67,(vlSelf->r[12]),32);
    bufp->chgIData(oldp+68,(vlSelf->r[13]),32);
    bufp->chgIData(oldp+69,(vlSelf->r[14]),32);
    bufp->chgIData(oldp+70,(vlSelf->r[15]),32);
    bufp->chgIData(oldp+71,(vlSelf->r[16]),32);
    bufp->chgIData(oldp+72,(vlSelf->r[17]),32);
    bufp->chgIData(oldp+73,(vlSelf->r[18]),32);
    bufp->chgIData(oldp+74,(vlSelf->r[19]),32);
    bufp->chgIData(oldp+75,(vlSelf->r[20]),32);
    bufp->chgIData(oldp+76,(vlSelf->r[21]),32);
    bufp->chgIData(oldp+77,(vlSelf->r[22]),32);
    bufp->chgIData(oldp+78,(vlSelf->r[23]),32);
    bufp->chgIData(oldp+79,(vlSelf->r[24]),32);
    bufp->chgIData(oldp+80,(vlSelf->r[25]),32);
    bufp->chgIData(oldp+81,(vlSelf->r[26]),32);
    bufp->chgIData(oldp+82,(vlSelf->r[27]),32);
    bufp->chgIData(oldp+83,(vlSelf->r[28]),32);
    bufp->chgIData(oldp+84,(vlSelf->r[29]),32);
    bufp->chgIData(oldp+85,(vlSelf->r[30]),32);
    bufp->chgIData(oldp+86,(vlSelf->r[31]),32);
    bufp->chgIData(oldp+87,(vlSelf->SingleCycleCPU__DOT__read_data1),32);
    bufp->chgIData(oldp+88,(vlSelf->SingleCycleCPU__DOT__read_data2),32);
    bufp->chgIData(oldp+89,(vlSelf->SingleCycleCPU__DOT__imm_out),32);
    bufp->chgIData(oldp+90,((vlSelf->SingleCycleCPU__DOT__imm_out 
                             << 1U)),32);
    bufp->chgIData(oldp+91,(vlSelf->SingleCycleCPU__DOT__pc_input),32);
    bufp->chgIData(oldp+92,(vlSelf->SingleCycleCPU__DOT__sum_2),32);
    bufp->chgIData(oldp+93,(vlSelf->SingleCycleCPU__DOT__MALU_o),32);
    bufp->chgIData(oldp+94,(vlSelf->SingleCycleCPU__DOT__read_data),32);
    bufp->chgIData(oldp+95,(vlSelf->SingleCycleCPU__DOT__write_data),32);
    bufp->chgIData(oldp+96,(vlSelf->SingleCycleCPU__DOT__mux_pc_output),32);
    bufp->chgIData(oldp+97,(vlSelf->SingleCycleCPU__DOT__sum_jalr),32);
    bufp->chgIData(oldp+98,(vlSelf->SingleCycleCPU__DOT__mux_writedata_output),32);
    bufp->chgCData(oldp+99,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Register__writeReg),5);
}
