...
VL_ATTR_COLD void VSingleCycleCPU___024root___dump_triggers__act(VSingleCycleCPU___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(4U)) {
        VL_DBG_MSGF("         'act' region trigger index 4 is active: @([changed] SingleCycleCPU.ALU_src or [changed] SingleCycleCPU.imm_out or [changed] SingleCycleCPU.read_data2)\n");
    }
    if (vlSelf->__VactTriggered.at(5U)) {
        VL_DBG_MSGF("         'act' region trigger index 5 is active: @([changed] SingleCycleCPU.ALU_res or [changed] SingleCycleCPU.mem_read)\n");
    }
    if (vlSelf->__VactTriggered.at(6U)) {
        VL_DBG_MSGF("         'act' region trigger index 6 is active: @([changed] SingleCycleCPU.ALU_res or [changed] SingleCycleCPU.mem_to_reg or [changed] SingleCycleCPU.read_data)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VSingleCycleCPU___024root___dump_triggers__nba(VSingleCycleCPU___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(4U)) {
        VL_DBG_MSGF("         'nba' region trigger index 4 is active: @([changed] SingleCycleCPU.ALU_src or [changed] SingleCycleCPU.imm_out or [changed] SingleCycleCPU.read_data2)\n");
    }
    if (vlSelf->__VnbaTriggered.at(5U)) {
        VL_DBG_MSGF("         'nba' region trigger index 5 is active: @([changed] SingleCycleCPU.ALU_res or [changed] SingleCycleCPU.mem_read)\n");
    }
    if (vlSelf->__VnbaTriggered.at(6U)) {
        VL_DBG_MSGF("         'nba' region trigger index 6 is active: @([changed] SingleCycleCPU.ALU_res or [changed] SingleCycleCPU.mem_to_reg or [changed] SingleCycleCPU.read_data)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VSingleCycleCPU___024root___ctor_var_reset(VSingleCycleCPU___024root* vlSelf) {
    ...
    vlSelf->SingleCycleCPU__DOT__ALU_Op = VL_RAND_RESET_I(2);
